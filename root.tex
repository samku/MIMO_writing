...
\hspace{4pt}
  ...
  \end{equation}
  If assumption 2 holds, the resulting set $\mathbb{O}_{N_P}$ is non-empty for $\mathbb{W}=\mathbb{W}_{\Omega}$, since it is non-empty for all $x_D(t) \in \mathbb{X}^D$. In combination, it means that the resulting set.
