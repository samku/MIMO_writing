...
\author{ Sampath Kumar Mulagaleti,  \iffalse Alberto Bemporad \fi % <-this % stops a space
\thanks{*This work was not supported by any organization}% <-this % stops a space
\thanks{\iffalse Sampath Kumar Mulagaleti and Alberto Bemporad are with
		the IMT School for Advanced Studies Lucca, Piazza San Francesco 19,
		55100 Lucca, Italy. 
		 Email: 
	   {\tt\small \{s.mulagaleti,alberto.bemporad\}@imtlucca.it} \fi }%%
}
...
\hspace{4pt}
  ...
  \fi
  In the next section, these two algorithms are simulated and compared, with the plant $\mathbb{G}_P$ being a 2-input 2-output linear system with parameters varying randomly.
  \iffalse
