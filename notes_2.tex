...
\author{Sampath Kumar Mulagaleti and Alberto Bemporad% <-this % stops a space
...
%	& \hspace{20pt}  g(t+k) \in \mathbb{G}_{\infty}(\gamma(t)) \\
	%& \hspace{20pt} \hat{\gamma}(t) = \gamma(t)
	%\end{matrix}
	\end{aligned}
	\label{RMPC}
	\end{equation}
